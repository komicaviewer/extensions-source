...
class Komica2ZawarudoSource : Source {
    override val id = Komica2ZawarudoBoards.SOURCE_ID
    ...
    override suspend fun getBoards(): List<Board> = Komica2ZawarudoBoards.all

    override suspend fun getThreadSummaries(board: Board, page: Int): List<ThreadSummary> {
        val supportedBoard = Komica2ZawarudoBoards.requireByUrl(board.url)
    ...
    override suspend fun getThread(summary: ThreadSummary): Thread {
        Komica2ZawarudoBoards.requireByUrl(summary.boardUrl)
