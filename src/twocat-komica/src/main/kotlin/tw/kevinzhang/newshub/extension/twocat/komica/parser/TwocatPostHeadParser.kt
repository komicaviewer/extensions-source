...
import tw.kevinzhang.newshub.extension.twocat.komica.toTimestamp
import java.util.logging.Logger

private val logger = Logger.getLogger("twocatPostHeadParser")

internal class TwocatPostHeadParser(
