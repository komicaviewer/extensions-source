...
class Komica2SoraBoardsTest {
    ...
    fun `catalog preserves the previously supported boards and order`() {
        assertEquals(
            listOf(
                Triple("二次裡A避難版", "https://2cat.uk/~chatura/pixmicat.php", "tw.kevinzhang.komica2.sora"),
                Triple("三次裡避難版", "https://2cat.uk/~realura/pixmicat.php", "tw.kevinzhang.komica2.sora"),
                Triple("高解析裡", "https://2cat.org/hiso/pixmicat.php", "tw.kevinzhang.komica2.sora"),
            ),
