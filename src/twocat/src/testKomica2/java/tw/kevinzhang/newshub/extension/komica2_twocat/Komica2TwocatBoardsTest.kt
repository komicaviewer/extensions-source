...
class Komica2TwocatBoardsTest {
    ...
    fun `catalog preserves requested order and has one animation board`() {
        assertEquals(
            listOf(
                Triple("GIF裡", "https://2cat.org/~gifura/pixmicat.php", "tw.kevinzhang.komica2.twocat"),
                Triple("動畫裡", "https://2cat.org/~hanime/pixmicat.php", "tw.kevinzhang.komica2.twocat"),
                Triple("成人玩具", "https://2cat.org/~toy/pixmicat.php", "tw.kevinzhang.komica2.twocat"),
                Triple("知識裡", "https://2cat.org/~know/pixmicat.php", "tw.kevinzhang.komica2.twocat"),
                Triple("偽娘裡", "https://2cat.org/~futa/pixmicat.php", "tw.kevinzhang.komica2.twocat"),
